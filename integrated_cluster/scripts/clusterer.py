...
with open('/deac/csc/khuriGrp/zhaok220/clustering/scripts/ga_parameters.yaml') as file:
...
def run_mo_gakmeans(datasets, numCenters, indPb = params['indPb'], mutPb = params['mutPb'], cxPb = params['cxPb'], numGen = params['numGen'], sizePop = params['sizePop'], crowding = params['crowding']):
   ...
   return co.ClusteringObject(centers, [intraclusterDistance,interclusterDistance],time.time()-start , [])
