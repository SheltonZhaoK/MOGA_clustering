2022-08-17 23:51:43.908736: W tensorflow/stream_executor/platform/default/dso_loader.cc:64] Could not load dynamic library 'libcudart.so.11.0'; dlerror: libcudart.so.11.0: cannot open shared object file: No such file or directory
2022-08-17 23:51:43.909088: I tensorflow/stream_executor/cuda/cudart_stub.cc:29] Ignore above cudart dlerror if you do not have a GPU set up on your machine.
...
Traceback (most recent call last):
  ...
  File "/deac/csc/khuriGrp/zhaok220/clustering_2/scripts/test_kidney.py", line 17, in main
    moea = run_mo_gakmeans(data,numClusters,numGen = 2, sizePop = 600)
