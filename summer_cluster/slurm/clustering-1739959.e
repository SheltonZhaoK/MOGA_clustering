Traceback (most recent call last):
  File "/deac/csc/khuriGrp/zhaok220/clustering/scripts/pop_iter_scrna.py", line 26, in <module>
    main(dirName,dataName)
  File "/deac/csc/khuriGrp/zhaok220/clustering/scripts/pop_iter_scrna.py", line 11, in main
    data, cellId = read_scrnaseq_data(dirName+dataName)
  File "/deac/csc/khuriGrp/zhaok220/clustering/scripts/reader.py", line 27, in read_scrnaseq_data
  ...
  File "/deac/csc/khuriGrp/software/zhaok220/lib/python3.8/site-packages/pandas/io/common.py", line 789, in get_handle
    handle = open(
FileNotFoundError: [Errno 2] No such file or directory: '/deac/csc/khuriGrp/zhaok220/clustering/data/scrna_benchmarks/10X_NCI_M_A_cellranger3.1_umap.csv'
