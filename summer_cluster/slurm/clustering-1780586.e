2022-07-13 16:41:18.654615: W tensorflow/stream_executor/platform/default/dso_loader.cc:64] Could not load dynamic library 'libcudart.so.11.0'; dlerror: libcudart.so.11.0: cannot open shared object file: No such file or directory
2022-07-13 16:41:18.654646: I tensorflow/stream_executor/cuda/cudart_stub.cc:29] Ignore above cudart dlerror if you do not have a GPU set up on your machine.
...
Traceback (most recent call last):
  ...
  File "/deac/csc/khuriGrp/zhaok220/clustering/scripts/test_keel.py", line 97, in main
    ga = run_mo_gakmeans(data,numCenters,numGen = 100, sizePop = 60)
